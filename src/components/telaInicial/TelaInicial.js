import {LogoInicial, TextoLogo, BotaoIniciar, EscolherDeck} from "./styledTelaInicial";

export default function TelaInicial( { setPartidaIniciada, deck, setDeck } ) {
    ...
    return(
        <>
            ...
            <EscolherDeck name="decks" onChange={ (e) => setDeck(e.target.value)}>
                <option>React</option>
                <option>Harry Potter</option>
            </EscolherDeck>
            <BotaoIniciar onClick={ iniciarPartida }>Iniciar Recall!</BotaoIniciar>
        </>
    )
}
